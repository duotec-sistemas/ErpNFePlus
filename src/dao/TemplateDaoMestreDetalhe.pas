...
type
  TDM_TemplateDaoMestreDetalhe = class(TServidorDao)
...
{ TTabelaBancoDao }
function TDM_TemplateDaoMestreDetalhe.BuscarTodos(
...
function TDM_TemplateDaoMestreDetalhe.Delete(const pId: string; pJson: TJSONObject): Boolean;
var
  s: string;
...
function TDM_TemplateDaoMestreDetalhe.Gravar(pId: String; pJson: TJSONObject): TFDQuery;
Var
  LJArray: TJsonArray;
  LJCampo: TJSONObject;
  LNomeCampo: String;
...
function TDM_TemplateDaoMestreDetalhe.Insert(pJson: TJSONObject): TFDQuery;
var
  s, NomeTabela: string;
  Qry: TFDQuery;
begin
...
procedure TDM_TemplateDaoMestreDetalhe.ValidarCamposAntesInsert(pJson: TJSONObject);
begin
...
function TDM_TemplateDaoMestreDetalhe.ObterPeloId(const pId: String): TFDQuery;
begin
...
function TDM_TemplateDaoMestreDetalhe.Update(const pId: string; pJson: TJSONObject): TFDQuery;
var
  s: string;
  Qry: TFDQuery;
begin

...
type
  TDM_TemplateDaoUnico = class(TServidorDao)
...
function TDM_TemplateDaoUnico.Delete(const pId: string;
...
function TDM_TemplateDaoUnico.Gravar(pId: String; pJson: TJsonObject): TFDQuery;
begin
...
function TDM_TemplateDaoUnico.Insert(pJson: TJsonObject): TFDQuery;
var
...
function TDM_TemplateDaoUnico.ObterPeloId(const pId: String): TFDQuery;
begin
...
function TDM_TemplateDaoUnico.Update(const pId: string; pJson: TJsonObject): TFDQuery;
var
  s: string;
  Qry: TFDQuery;
begin
...
function TDM_TemplateDaoUnico.BuscarTodos(

unit PDVAlterarQuantidade.client.erpnfe;
...
type
  TView_AlterarQuantidade = class(TForm)
...
var
  View_AlterarQuantidade: TView_AlterarQuantidade;

implementation

{$R *.dfm}

procedure TView_AlterarQuantidade.FormCreate(Sender: TObject);
begin
  Self.Left := 0;
  Self.Top := 0;
...
procedure TView_AlterarQuantidade.FormKeyDown(Sender: TObject;
...
procedure TView_AlterarQuantidade.SetControllerPDV(const Value: IControllerPDV);
begin
